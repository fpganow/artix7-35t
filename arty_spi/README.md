## The purpose of this is project is to implement lwIP with a custom Ethernet MAC, this project injects a single UDP packet and prints to the UART the value "WINNING" if that packet is received.
